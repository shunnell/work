...
# TO DO should be migrated to admin_eks
dependency "cluster" {
...
inputs = {
  domain       = "gitlab.${local.suffix}.cloud-city" ## TO DO: Change this to the actual domain when running in prod
  ...
  acm_cert_arn            = "arn:aws:acm:us-east-1:381492150796:certificate/71ba9919-33c9-4d9a-8365-3923c1ea56db"
