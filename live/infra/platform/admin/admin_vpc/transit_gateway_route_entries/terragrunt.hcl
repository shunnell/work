...
locals {
  ...
  vpc_vars = read_terragrunt_config(find_in_parent_folders("admin_vpc.hcl"))
}

dependency "egress_vpc_transit_gateway_attachment" {
...
inputs = {
  tgw_routes = {
    ...
    "vpc_to_nonprod_egress" = {
      ...
      transit_gateway_attachment_id  = dependency.egress_vpc_transit_gateway_attachment.outputs.transit_gateway_attachment_id
    },
