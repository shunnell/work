...
dependency "alert_log_group" {
  config_path = "../../prod_inspection_firewall/alert_logs_group"
  mock_outputs = {
...
dependency "flow_log_group" {
  config_path = "../../prod_inspection_firewall/flow_logs_group"
  mock_outputs = {
...
dependency "tls_log_group" {
  config_path = "../../prod_inspection_firewall/tls_logs_group"
  mock_outputs = {
    cloudwatch_log_group_name = "mock-tls-log-group"
  }
}

dependency "prod_vpc_rule_group" {
  config_path = "../firewall_rule_groups/prod_vpc_rule_group"
  mock_outputs = {
