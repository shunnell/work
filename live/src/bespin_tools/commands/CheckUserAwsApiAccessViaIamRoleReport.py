        ...
        try:
                ...
                for user in users:
                    ...
                    for key in access_keys:
                        ...
                        service_name = last_used_response.get('AccessKeyLastUsed', {}).get('ServiceName', 'N/A')

                        if status == "Active":
                            print(f"access key {access_key_id} for user {user_name} in account {account.account_name} is active and last used: {last_used_date}, Service: {service_name}.")
                        else: 
                            print(f"Access key {access_key_id} for user {user_name} in account {account.account_name} is inactive and last used: {last_used_date}, Service: {service_name}.")
...
# CMD ==> rye run bespinctl users list-user-credentials