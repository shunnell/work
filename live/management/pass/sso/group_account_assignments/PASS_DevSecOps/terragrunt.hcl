...
dependency "pass_devsecops" {
  config_path = "../../permission_sets/PASS_DevSecOps"
  mock_outputs = {
    permission_set_arn = "arn:aws:sso:::permissionSet/mock-12345"
  }
}

dependency "pass_devsecops_infra" {
  config_path = "../../permission_sets/PASS_DevSecOps_Infra"
  mock_outputs = {
    permission_set_arn = "arn:aws:sso:::permissionSet/mock-12345"
  }
}
...
locals {
  tenant_account_id = read_terragrunt_config("${get_repo_root()}/pass/account.hcl").locals.account_id
...
inputs = {
  group_display_name = "Cloud City PASS DevSecOps Enterprise Users"
  account_to_permission_set_map = tomap({
    (local.tenant_account_id) = dependency.sandbox_dev.outputs.permission_set_arn
    (local.infra_account_id)  = dependency.pass_devsecops_infra.outputs.permission_set_arn
    (local.prod_account_id)   = dependency.pass_devsecops.outputs.permission_set_arn
  })
}
