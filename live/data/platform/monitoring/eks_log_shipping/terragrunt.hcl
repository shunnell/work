...
inputs = {
  ...
  log_group_arns = [
    "arn:aws:logs:${include.account.locals.region}:${include.account.locals.account_id}:log-group:/aws/eks/ccd-mod-data-platform-dev-vpc23-eks-cluster-us-east1/cluster",
    "arn:aws:logs:${include.account.locals.region}:${include.account.locals.account_id}:log-group:/aws/containerinsights/ccd-mod-data-platform-dev-vpc23-eks-cluster-us-east1/dataplane"
  ]
}