...
inputs = {
  ...
  log_group_arns = [
    "arn:aws:logs:${include.account.locals.region}:${include.account.locals.account_id}:log-group:/aws/eks/demo-eks/cluster",
    "arn:aws:logs:${include.account.locals.region}:${include.account.locals.account_id}:log-group:/aws/eks/dev-eks/cluster",
    "arn:aws:logs:${include.account.locals.region}:${include.account.locals.account_id}:log-group:/aws/eks/test-eks/cluster"
  ]
}